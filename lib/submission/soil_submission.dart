...
import 'package:tea_sampling/submission/user_soil.dart';

class SoilSubmission extends StatefulWidget {
  const SoilSubmission({super.key});

  @override
  State<SoilSubmission> createState() => SoilSubmissionState();
}

class SoilSubmissionState extends State<SoilSubmission> {
  Stream? userStream;
  String? userId;
  ...
  getUserDetailsStream() async {
    ...
    if (currentUser != null) {
      ...
      userStream = DatabaseMethods()
          .getUserDetails(userId!, collection: 'Soil detail form');
      setState(() {});
    }
  }
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          UserSoilDetailScreen(userDetails: userDetails),
                    ),
                  );
                },
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          await DatabaseMethods().deleteUserDetails(
                              userDetails["id"],
                              collection: 'Soil detail form');
                        },
                      ),
                    ],
                  ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const UserSoil()));
        },
...
class UserSoilDetailScreen extends StatelessWidget {
  final Map<String, dynamic> userDetails;

  const UserSoilDetailScreen({super.key, required this.userDetails});
