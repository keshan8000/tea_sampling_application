...
class _UserSoilState extends State<UserSoil> {
  ...
  void initState() {
    ...
    if (widget.isEditing && widget.userDetails != null) {
      ...
      lastdcontroller.text =
          widget.userDetails!["Date last dolomite application"];
    ...
    if (enteredAmount != totalCost) {
      ...
      if (widget.isEditing) {
        await DatabaseMethods()
            .updateUserDetails(id, userInfoMap, collection: 'Soil detail form');
      } else {
        await DatabaseMethods()
            .addUserDetails(userInfoMap, id, collection: 'Soil detail form');
      }
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              SoilConfirmationScreen(userId: id, totalCost: totalCost),
        ),
      );
    }
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                  "Date last dolomite application", lastdcontroller),
