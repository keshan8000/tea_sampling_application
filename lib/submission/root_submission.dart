  ...
  getUserDetailsStream() async {
    ...
    if (currentUser != null) {
      ...
      userStream = DatabaseMethods()
          .getUserDetails(userId!, collection: 'Root detail form');
      setState(() {});
    }
  }
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          UserRootDetailScreen(userDetails: userDetails),
                    ),
                  );
                },
                child: ListTile(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const UserRoot()));
        },
...
class UserRootDetailScreen extends StatelessWidget {
  ...
  const UserRootDetailScreen({super.key, required this.userDetails});
